...
const base =
  ...
  'transition-colors focus:border-ember-500 focus:outline-none focus:ring-2 focus:ring-ember-500/30 disabled:opacity-60';
...
function FieldShell({
  ...
  return (
    <label className="block">
      {label && (
        <span className="mb-1.5 block text-[0.68rem] font-bold uppercase tracking-[0.14em] text-ink-soft">{label}</span>
      )}
      {children}
      {error ? (
